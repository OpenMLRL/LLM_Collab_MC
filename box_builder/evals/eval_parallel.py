#!/usr/bin/env python3
"""
Parallel evaluation for box_builder (2 agents, 1 turn, IoU metric).
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Parallel evaluation for box_builder (IoU metric).")
    parser.add_argument(
        "--config",
        type=str,
...
def main() -> int:
    ...
    evaluate_box_builder(cfg, args, run_label="parallel")
    return 0
