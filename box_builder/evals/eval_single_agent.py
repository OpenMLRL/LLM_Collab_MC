#!/usr/bin/env python3
"""
Single-agent evaluation for box_builder (1 agent, 1 turn, IoU metric).
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Single-agent evaluation for box_builder (IoU metric).")
    parser.add_argument(
        "--config",
        type=str,
...
def main() -> int:
    ...
    evaluate_box_builder(cfg, args, run_label="single_agent")
    return 0
