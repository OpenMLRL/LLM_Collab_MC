...
from LLM_Collab_Minecraft.house_builder.utils.trainer_args import get_trainer_args
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train house_builder with GRPO (CoMLRL MAGRPOTrainer)")
    parser.add_argument(
        "--config",
        type=str,
        default=os.path.join(REPO_ROOT, "house_builder", "configs", "house_builder_magrpo_config.yaml"),
