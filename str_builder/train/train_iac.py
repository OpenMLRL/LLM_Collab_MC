...
from LLM_Collab_MC.str_builder.utils.trainer_args import get_iac_args
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train str_builder with IAC (CoMLRL IACTrainer)")
    parser.add_argument(
        "--config",
        type=str,
        default=os.path.join(REPO_ROOT, "str_builder", "configs", "str_builder_iac_config.yaml"),
