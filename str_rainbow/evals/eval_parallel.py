#!/usr/bin/env python3
"""
Parallel evaluation for str_rainbow (2 agents, 1 turn, no feedback).
Uses the shared multi-turn evaluator with num_turns=1 to match parallel mode.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Parallel evaluation for str_rainbow (IoU metric).")
    parser.add_argument(
        "--config",
        type=str,
