#!/usr/bin/env python3
"""
Single-agent evaluation for str_rainbow (IoU metric).
Runs one agent, one turn, using the shared evaluator.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Single-agent evaluation for str_rainbow (IoU metric).")
    parser.add_argument(
        "--config",
        type=str,
