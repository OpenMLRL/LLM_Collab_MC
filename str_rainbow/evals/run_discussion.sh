#!/usr/bin/env bash
#
# str_rainbow Discussion evaluation (multi-turn with feedback, IoU metric)
#
...
CONFIG_FILE="${CONFIG_FILE:-evals/configs/discussion_config.yaml}"

echo "=============================================="
echo "str_rainbow Discussion Evaluation"
