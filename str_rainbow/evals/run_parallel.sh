#!/usr/bin/env bash
#
# str_rainbow Parallel evaluation (2 agents, 1 turn, IoU metric)
#
# Usage:
#   bash evals/run_parallel.sh
#   bash evals/run_parallel.sh --eval-split "[:8]" --verbose
#
...
echo "=============================================="
echo "str_rainbow Parallel Evaluation"
...
python evals/eval_parallel.py --config "${CONFIG_FILE}" "$@"
STATUS=$?
